		...
		while (true) {
			...
			if (n == 0) {
				...
				if (a == 1) {
					...
					emps.addNewEmployee(name, id, desig, sal);
				}
				else if (a == 2) {
					String name, id, desig;
					double hourlyRate;
					...
					emps.addNewEmployee(name, id, desig, hourlyRate, hourWorked);
				}
				else if (a == 3) {
					String name, id, desig;
					...
					emps.addNewEmployee(name, id, desig, commission, sale);
				}
			}
			else if (n == 2) {
				System.out.println("Enter an Id:");
